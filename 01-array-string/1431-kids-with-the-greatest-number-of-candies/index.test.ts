...
describe("1431. Kids With the Greatest Number of Candies - Easy", () => {

    test('Input1: candies = [2,3,5,1,3], extraCandies = 3', () => {
        const candies = [2, 3, 5, 1, 3], extraCandies = 3
        const result = [true, true, true, false, true]
        expect(kidsWithCandies(candies, extraCandies)).toEqual(result);
    });

    test('Input2: candies = [4,2,1,1,2], extraCandies = 1', () => {
        const candies = [4, 2, 1, 1, 2], extraCandies = 1
        const result = [true, false, false, false, false]
        expect(kidsWithCandies(candies, extraCandies)).toEqual(result);
    });

    test('Input3: candies = [12,1,12], extraCandies = 10', () => {
