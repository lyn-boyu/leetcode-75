...
describe("334.- Increasing Triplet Subsequence - Medium", () => {

    test('Input1: nums = [1,2,3,4,5]', () => {
        const nums = [1, 2, 3, 4, 5]
        expect(increasingTriplet(nums)).toEqual(true);
    });

    test('Input2: nums = [5,4,3,2,1]', () => {
        const nums = [5, 4, 3, 2, 1]
        expect(increasingTriplet(nums)).toEqual(false);
    });

    test('Input3:  nums = [2,1,5,0,4,6]', () => {
