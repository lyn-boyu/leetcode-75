...
describe("1466. Reorder Routes to Make All Paths Lead to the City Zero - Medium", () => {

    test("Input1: n = 6, connections = [[0,1],[1,3],[2,3],[4,0],[4,5]]", () => {
        const connections = [[0, 1], [1, 3], [2, 3], [4, 0], [4, 5]]
        const n = 6
        const result = solution(n, connections);
        expect(result).toEqual(3);
    });


    test("Input2: n = 5, connections = [[1,0],[1,2],[3,2],[3,4]]", () => {
    ...
    test("Input3: n = 3, connections = [[1,0],[2,0]]", () => {
