...
describe("1657. Determine if Two Strings Are Close - Medium ", () => {

    test("Input1: word1 = \"abc\", word2 = \"bca\" ", () => {
        let word1 = "abc", word2 = "bca";
        const result = solution(word1, word2);
        expect(result).toEqual(true);
    });

    test("Input2: word1 = \"a\", word2 = \"aa\" ", () => {
        let word1 = "a", word2 = "aa";
        const result = solution(word1, word2);
        expect(result).toEqual(false);
    });

    test("Input3: word1 = \"cabbba\", word2 = \"abbccc\" ", () => {
