...
describe("452. Minimum Number of Arrows to Burst Balloons - Medium", () => {

    test('Input1: points = [[10,16],[2,8],[1,6],[7,12]]', () => {
        const points = [[10, 16], [2, 8], [1, 6], [7, 12]]
        expect(findMinArrowShots(points)).toEqual(2);
    });

    test('Input2:  points = [[1,2],[3,4],[5,6],[7,8]]', () => {
        const points = [[1, 2], [3, 4], [5, 6], [7, 8]]
        expect(findMinArrowShots(points)).toEqual(4);
    });

    test('Input3: points = [[1,2],[2,3],[3,4],[4,5]]', () => {
